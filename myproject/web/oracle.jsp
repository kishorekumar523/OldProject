...
<title>oracle</title></head>
     <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link href="styles1.css" rel="stylesheet" type="text/css" />
<body bgcolor="#999999">
 <h1><font color="maroon"><marquee>ORACLE</marquee></font></h1>
<div id="buttons">
         <ul>
...
<p class="kitty">User name</br><%=session.getAttribute("username")%></p>
 ...
 </br></br></br></br></br><a href="oracle1.jsp">To Write an Exam </br></br> CLICK HERE</br><img src="click.jpg"/></a>
</body>
</html>